...
//   DIGEST_AUTH,
//   USER_SEARCH_AUTOCOMPLETE_INDEX_NAME,
// } from "./setup";
// import { request } from "urllib";

// export async function upsertUserAutocomplete() {
...
//   console.log("🟡 Creating index:", USER_SEARCH_AUTOCOMPLETE_INDEX_NAME);
//   await request(ATLAS_SEARCH_INDEX_API_URL, {
//     data: {
//       name: USER_SEARCH_AUTOCOMPLETE_INDEX_NAME,
//       database: dbName,
