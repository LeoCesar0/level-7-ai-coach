...
export const ARCHETYPES = {
    theRisingStart: 'The Rising Star: Young athletes with high potential benefit significantly from targeted development and motivational strategies. Focusing on their growth and skill enhancement can help them reach their peak performance early and sustain it over time.'
}
